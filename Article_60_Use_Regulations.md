...
[*Detailed standards for accessory dwelling units*]

### B. Accessory Structures
[*Detailed standards for accessory structures*]
...
2. **Large animal standards** equal no more than an average of 1 adult plus 1 young under 6 month. This standard applies to cattle, horses, mules, emus, and the like, but not to chickens and other small domestic animals.
...
5. **Companion animals** are limited to 3 domesticated dogs per household over six months of age, 4 domesticated cats over six months of age per household, and 1 horse plus 1 foal based per acre in all residential zones. Horses and other such large animals are only allowed on lots of 3 acres or larger.
...
3. **Exemptions** include:
   - Institutions accredited by the [American Zoo and Aquarium Association](https://www.aza.org/)
...
1. **Federal Requirements** - All towers must meet or exceed current standards and regulations of the [FAA](https://www.faa.gov/), the [FCC](https://www.fcc.gov/), and any other agency or department of the federal government with the authority to regulate towers and antennas.
...
3. **Separation from Existing Towers** - [*Detailed separation requirements table*]
...
2. An accessory dwelling unit may be incorporated within the principle structure or may be a separate unit located within 100 feet of the principle structure.
...
3. Compliance with all applicable state regulations ([RSMo 320](https://revisor.mo.gov/main/OneChapter.aspx?chapter=320)) shall be required.
