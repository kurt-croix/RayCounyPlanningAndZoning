#!/usr/bin/env python3
"""
Fix Article 30 by extracting missing content from txt and appending to markdown
"""
...
# Extract lines 1290-2733 (0-indexed: 1289-2733)
remaining_content = ''.join(all_lines[1289:2734])
...
# The content to append (formatted as markdown)
new_content = """
**1. Exemptions**

The following shall be exempt from the procedures of this Article:

a. A transaction between owners of adjoining unplatted proinvolves only a change in the boundary between the land owned by such persons provided no additional tracts are created and such tracts comply with the lot size and setback standards of the underlying zoning district.
...
c. The conveyance of land for street or railroad right-of-way, utility or drainage easements, or other public utility purposes subject to local, state, or federal regulations no new street or access easements are created.
...
10. Does not adversely affect the remainder of the parceing properties and is not in conflict with any provisions of the Ray County Comprehensive Plan or these regulations.
...
A Minor Subdivision application shall be completed and submitted to the Planning and Zoning Department on forms available in the Planning and Zoning Department. All required inforion must be filed with the Planning and Zoning Department at least 15 days prior to a regular meeting of the Planning and Zoning Commission at which the Final Plat is to be considered.
...
A completed application for Final Plat, along with the appropriate application fees, shall be submitted at least 15 days prior to thing at which the Planning and Zoning Commission shall review the application. If Rezoning, application and appropriate application fees shall be submitted at least 15 working days before Planning and Zoning meeting.
...
Within 30 days of receipt of a complete Final Plat application, thning and Zoning Commission shall review the Final Plat and take action on the application based on the Approval Criteria of Article 30.3F.
...
The Planning and Zoning Commission may approve final Plat if they determine that all of following approval criteria has been met:
   ...
   (1) The subdivision complies with zoning regulations of the district in which it is located, the Subdivision Design and Improvement Standards of [Article 80](Article_80_Subdivision_Design_Improvements.md) and with all othele standards of these Zoning Regulations; and
...
A recommendation of denial of a Final Plat by the Planning and Zoning Commission shall be forwarded to the County Commission for action,ess the applicant requests the application be withdrawn in writing within 30 days of the public hearing.
...
A Final Plat may be approved byCommission if they determine that the application complies with the Zoning Regulations.
...
Any person aggrieved by a decision of the County Commission on a Final Plat Application may present to the Circuit Court of Ray County a petition, duly verified, setting forth that such decision is illegal, in whole or inrt, specifying the grounds of the illegality. Such petition shall be presented to the Court within 30 days of the date of the County Commission's decision on the matter.
...
with open('C:/Users/KurtBognar/Downloads/RayCountyZoning/Article_30_Development_Review_Procedures.md', 
          oding='utf-8') as f:
    f.write(existing_md.rstrip() + '\n' + new_content)

print("Added 30.5 Minor Subdivision section")
print("Next: Need to add sections 30.6 through 30.14")
